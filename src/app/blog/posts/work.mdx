...
summary: "Design system open-source pour créateurs, petites équipes et startups."
images:
...
You can use MDX to write the content of your projects. It helps you write rich and dynamic content with minimal code. Some MDX elements will be automatically transformed to Thioune ui components to integrate better in the design and add additional functionality.
